...
$(function() {
	...
	// sum image of photo slide 01
	var number01=$('#photo01 li').size();
	//alert(number01);
	var html01=$('#photo01').html();	
	switch(number01)
	{
		case 2:
			    $(html01).appendTo('#photo01');
				$(html01).appendTo('#photo01');
		  break;
	...
	$('#photo01').carouFredSel({
		...
		scroll: {
			...
			pauseOnHover: false,
			duration: d_slide,
			timeoutDuration: t_slide
		},
		direction: 'right'
	});
	
	// sum image of photo slide 02
	var number02=$('#photo02 li').size();
	//alert(number02);
	var html02=$('#photo02').html();	
	switch(number02)
	{
		case 2:
			    $(html02).appendTo('#photo02');	
				$(html02).appendTo('#photo02');
				$(html02).appendTo('#photo02');
		case 3:
			    $(html02).appendTo('#photo02');	
	...
	// sum image of photo slide 03
	var number03=$('#photo03 li').size();
	//alert(number03);
	var html03=$('#photo03').html();	
	switch(number03)
	{
		case 2:
			    $(html03).appendTo('#photo03');	
				$(html03).appendTo('#photo03');
				$(html03).appendTo('#photo03');
		  break;	
		case 3:
	...
	// sum image of photo slide 04
	var number04=$('#photo04 li').size();
	//alert(number04);
	var html04=$('#photo04').html();	
	switch(number04)
	{
		case 2:
			    $(html04).appendTo('#photo04');	
				$(html04).appendTo('#photo04');
				$(html04).appendTo('#photo04');
		  break;
		case 3:
	...
	// sum image of photo slide 05
	var number05=$('#photo05 li').size();
	//alert(number05);
	var html05=$('#photo05').html();	
	switch(number05)
	{
		case 2:
			    $(html05).appendTo('#photo05');	
				$(html05).appendTo('#photo05');
				$(html05).appendTo('#photo05');
		  break;
