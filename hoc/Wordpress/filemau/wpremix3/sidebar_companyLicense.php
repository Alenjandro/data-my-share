...
<li id="lNavMessage"><a href="<?php bloginfo('url'); ?>/company/message/"><img src="<?php bloginfo('template_url'); ?>/images/company/lnav_message.gif" alt="トップメッセージ" class="imgover" /></a></li>
...
<li id="lNavLicense"><a href="<?php bloginfo('url'); ?>/company/license/"><img src="<?php bloginfo('template_url'); ?>/images/company/lnav_license_o.gif" alt="主な国家資格保有者" /></a></li>
