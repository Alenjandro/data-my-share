...
function TB_ShowObj(ThickObj) {
	...
	try {
		...
		if (TB_PrevObj != null) {
			TB_PrevHTML = "<p id='TB_prev'><a href='#'><img src='/wp/wp-content/themes/wpremix3/images/common/btn_prev.gif' alt='前へ' class='imgover'></a></p>";
		} else {
			TB_PrevHTML = "";				
		}
		TB_NextObj = TB_getNextObj(ThickObj);
		if (TB_NextObj != null) {
			TB_NextHTML = "<p id='TB_next'><a href='#'><img src='/wp/wp-content/themes/wpremix3/images/common/btn_next.gif' alt='次へ' class='imgover'></a></p>";
		} else {
			TB_NextHTML = "";				
		}
 		
		//$("#TB_overlay").show();
		$("body").append("<div id='TB_load'><div id='TB_loadContent'><img src='../common/images/img_loading.gif' /></div></div>");
		...
		switch (urlType) {
			...
			default:
				...
				$("#TB_window").append("<div id='TB_ajaxContent' style='width:"+ajaxContentW+"px;height:"+ajaxContentH+"px;'></div><div id='TB_closeAjaxWindow'><p id='TB_close'><a href='#' id='TB_closeWindowButton'><img src='/wp/wp-content/themes/wpremix3/images/common/btn_close.gif' alt='閉じる' class='imgover'></a></p>" + TB_PrevHTML + TB_NextHTML + "</div>");
				$("#TB_closeWindowButton").click(TB_remove);
