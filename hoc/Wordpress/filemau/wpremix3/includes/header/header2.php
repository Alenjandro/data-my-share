...
<div id="header2" >
	<div class="h_left">
     ...
     <img src="<?php bloginfo('template_url'); ?>/images/logo2.png" alt="<?php bloginfo('name'); ?>"  /></a>
      </div> <!--h_left #end -->
     ...
     <div class="h_right">
	   <ul id="topnav">
     		...
     		<p class="hspcaer i_phone"> <strong class="red">Call Us :</strong> 111 111 1111</p>
     	 	<p class="i_mail"> <strong  class="red">Email :</strong> <a href="#">companyname@support.com</a></p>
  </div>
