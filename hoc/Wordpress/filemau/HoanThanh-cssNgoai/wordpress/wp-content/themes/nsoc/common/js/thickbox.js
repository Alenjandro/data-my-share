...
function TB_ShowObj(ThickObj) {
	...
	try {
		...
		if (document.getElementById("TB_overlay") == null) {
			$("body").append("<div id='TB_overlay' class='clearfix'></div><div id='TB_window' class='clearfix'></div>");
		...
		if (TB_PrevObj != null) {
			TB_PrevHTML = "<p id='TB_prev'><a href='#'><img src='/wordpress/wp-content/themes/nsoc/common/images/btn_prev.gif' alt='前へ'></a></p>";
		} else {
			TB_PrevHTML = "";				
		}
		TB_NextObj = TB_getNextObj(ThickObj);
		if (TB_NextObj != null) {
			TB_NextHTML = "<p id='TB_next'><a href='#'><img src='/wordpress/wp-content/themes/nsoc/common/images/btn_next.gif' alt='次へ'></a></p>";
		} else {
			TB_NextHTML = "";				
		}
 		
		//$("#TB_overlay").show();
		$("body").append("<div id='TB_load'><div id='TB_loadContent'><img src='/wordpress/wp-content/themes/nsoc/common/images/img_loading.gif' /></div></div>");
		...
		switch (urlType) {
			...
			default:
				...
				TB_HEIGHT = (params['height']*1) + 180;
				ajaxContentW = TB_WIDTH;
				ajaxContentH = TB_HEIGHT-40;
				$("#TB_window").append("<div id='TB_ajaxContent' style='width:"+ajaxContentW+"px;height:"+ajaxContentH+"px;'></div><div id='TB_closeAjaxWindow'><p id='TB_close'><a href='#' id='TB_closeWindowButton'><img src='/wordpress/wp-content/themes/nsoc/common/images/btn_close.gif' alt='閉じる'></a></p>" + TB_PrevHTML + TB_NextHTML + "</div>");
				$("#TB_closeWindowButton").click(TB_remove);
...
function TB_HideBox_Part2() {
	$("#TB_load").remove();
	$("#TB_window").remove();
	$("body").append("<div id='TB_window' class='clearfix'></div>");
...
function TB_position() {
	...
	$("#TB_window").css({width:TB_WIDTH+"px",height:TB_HEIGHT-16+"px",
	left: ((pagesize[0] - TB_WIDTH)/2)+"px", top: (arrayPageScroll[1] + ((pagesize[1]-TB_HEIGHT)/2))+"px" });
	$("#TB_closeAjaxWindow").css("width",TB_WIDTH +"px");
	$("#TB_overlay").css("height",yScroll +"px");
	$("#TB_close").css("left",(TB_WIDTH/2-31) +"px");
}
