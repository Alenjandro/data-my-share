...
<?php elseif(is_category() || is_archive() || is_single()): ?>
...
<p><a href="http://www.nsc-eng.co.jp/" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/common/images/btn_nippon.gif" alt="新日鉄エンジニアリング" class="imgover" /></a></p>
<!-- / class hSection --></div>
