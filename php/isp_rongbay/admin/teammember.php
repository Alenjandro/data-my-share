<?php
include "check.php";?>
<div style="width:96%" align="left"><strong>CẬP NHẬT QUY CHẾ THÀNH VIÊN:</strong></div>

<?php
if($_POST['UpdateIntro']){			
			  			
				
				mysql_query("UPDATE ".team_member." SET full='".$_POST['full']."' WHERE id=".intval($_POST['id'])."");
...
<?php
$sqlstr=mysql_query("SELECT * FROM ".team_member."");
