<?php
include "check.php";?>
<div style="width:96%" align="left"><strong>CẬP NHẬT LIÊN HỆ QUẢNG CÁO:</strong></div>

<?php
if($_POST['UpdateIntro']){			
			  			
				
				mysql_query("UPDATE ".adv." SET full='".$_POST['full']."' WHERE id=".intval($_POST['id'])."");
...
<?php
$sqlstr=mysql_query("SELECT * FROM ".adv."");
